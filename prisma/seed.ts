  ...
  await prisma.match.createMany({
    data: [
      ...
      // Grupo B — encerrados
      {
        ...
        status: 'ENCERRADO',
        groupId: groupB.id,
        homeTeamId: franca.id,
        awayTeamId: marrocos.id,
      },
      {
        date: new Date('2026-06-11T15:00:00Z'),
        local: 'Arena Corinthians',
        homeGoals: 1,
        awayGoals: 1,
        status: 'ENCERRADO',
        groupId: groupB.id,
        homeTeamId: espanha.id,
        awayTeamId: alemanha.id,
      },
      // Grupo B — próximos
      {
      ...
      },
      {
        ...
        status: 'ENCERRADO',
        groupId: groupC.id,
        homeTeamId: uruguai.id,
        awayTeamId: croacia.id,
      },
      // Grupo C — próximos
      {
      ...
      // Grupo D — encerrados
      {
        ...
        status: 'ENCERRADO',
        groupId: groupD.id,
        homeTeamId: inglaterra.id,
        awayTeamId: camaroes.id,
      },
      {
        ...
        status: 'ENCERRADO',
        groupId: groupD.id,
        homeTeamId: belgica.id,
        awayTeamId: italia.id,
      },
      // Grupo D — próximos
      {
      ...
      {
        date: new Date('2026-06-19T15:00:00Z'),
        local: 'Estádio Nacional',
        homeGoals: null,
        awayGoals: null,
        status: 'PROXIMO',
  ...
  await prisma.news.createMany({
    data: [
      ...
      },
      {
        ...
        summary:
          'Seleção francesa domina o jogo e vence por 2 a 0 na estreia do Grupo B.',
      ...
      },
      {
        ...
        summary:
          'Seleção portuguesa vence por 2 a 1 e lidera a chave após a primeira rodada.',
      ...
      },
      {
        ...
        image:
          'https://images.unsplash.com/photo-1686484527934-6e49abf574be?w=800',
        readingTime: 3,
        authorId: admin.id,
        groupId: groupD.id,
      },
      ...
      },
      {
        ...
        summary:
          'Entenda as regras usadas para definir a classificação em caso de empate em pontos.',
        ...
        image:
          'https://images.unsplash.com/photo-1511204579483-e5c2b1d69acd?w=800',
        readingTime: 2,
        authorId: admin.id,
        groupId: null,
      },
