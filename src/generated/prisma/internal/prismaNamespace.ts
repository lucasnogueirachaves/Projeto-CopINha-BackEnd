...
> = {
  ...
  meta: {
    modelProps: 'admin' | 'team' | 'group' | 'match' | 'news' | 'actionLog'
    ...
    ActionLog: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.ActionLogCountAggregateOutputType>
            | number
        }
      }
    }
 ...
 * Reference to a field of type 'MatchStatus[]'
 */
export type ListEnumMatchStatusFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'MatchStatus[]'
>
 ...
 * Reference to a field of type 'Action[]'
 */
export type ListEnumActionFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'Action[]'
>
